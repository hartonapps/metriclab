  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors dark:bg-slate-950 dark:text-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6">
        ...
        <section className="mb-6 rounded-3xl bg-gradient-to-br from-brand-100 via-white to-white p-6 shadow-soft dark:from-brand-900 dark:via-slate-900 dark:to-slate-900">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="mb-2 text-sm font-medium text-brand-600">Instagram: @metriclab</p>
            ...
            <a href={buildWhatsAppLink('a Shopify tool')} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-brand-500 px-4 py-2 text-sm font-medium text-white">
              <MessageCircle size={16} /> Chat on WhatsApp
            </a>
          </div>
          <div className="mt-5 grid grid-cols-1 gap-3 text-sm sm:grid-cols-3">
            <div className="rounded-2xl border border-brand-200 bg-white/70 px-4 py-3 dark:border-brand-800 dark:bg-slate-900/60">
              <p className="text-slate-500 dark:text-slate-300">Fast delivery</p>
              <p className="font-semibold">Direct support on WhatsApp</p>
            </div>
            <div className="rounded-2xl border border-brand-200 bg-white/70 px-4 py-3 dark:border-brand-800 dark:bg-slate-900/60">
              <p className="text-slate-500 dark:text-slate-300">Frontend managed</p>
              <p className="font-semibold">Realtime Firebase products</p>
            </div>
            <div className="rounded-2xl border border-brand-200 bg-white/70 px-4 py-3 dark:border-brand-800 dark:bg-slate-900/60">
              <p className="text-slate-500 dark:text-slate-300">Trusted brand</p>
              <p className="font-semibold">Metric Labs Shopify Tools</p>
            </div>
          </div>
        </section>
        ...
        <div className="mb-2 flex items-center justify-between">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Professional Shopify growth utilities</p>
        </div>
